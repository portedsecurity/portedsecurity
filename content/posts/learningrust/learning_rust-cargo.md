...
Open src/main.rs. You will see the most famous lines in programming:
...
You have officially compiled and executed your first Rust program. You now have a grasp of how **Cargo** structures a project, and the foundation to start writing real logic.
